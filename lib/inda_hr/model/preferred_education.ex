...
defmodule inda_hr.Model.PreferredEducation do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :"Title" => inda_hr.Model.PreferredEducationTitle.t | nil,
...
defimpl Poison.Decoder, for: inda_hr.Model.PreferredEducation do
  import inda_hr.Deserializer
  def decode(value, options) do
    value
    |> deserialize(:"Title", :struct, inda_hr.Model.PreferredEducationTitle, options)
