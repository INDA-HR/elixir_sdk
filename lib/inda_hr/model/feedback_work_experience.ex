...
defmodule inda_hr.Model.FeedbackWorkExperience do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :PositionTitle => inda_hr.Model.FeedbackJobTitle.t | nil,
...
defimpl Poison.Decoder, for: inda_hr.Model.FeedbackWorkExperience do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:PositionTitle, :struct, inda_hr.Model.FeedbackJobTitle, options)
