...
defmodule IndaHr.Model.JobadCommonOptionalData do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    :JobTitle => IndaHr.Model.JobTitleHeader.t | nil,
    :JobDescription => IndaHr.Model.JobDescription.t | nil,
    ...
    :Skills => IndaHr.Model.Skills.t | nil,
...
defimpl Poison.Decoder, for: IndaHr.Model.JobadCommonOptionalData do
