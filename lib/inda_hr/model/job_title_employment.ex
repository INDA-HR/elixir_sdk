...
defmodule inda_hr.Model.JobTitleEmployment do
  @moduledoc """
  ...
  @type t :: %__MODULE__{
    ...
    :"Activities" => [inda_hr.Model.Activity.t] | nil
  }
end

defimpl Poison.Decoder, for: inda_hr.Model.JobTitleEmployment do
  ...
  def decode(value, options) do
    ...
    |> deserialize(:"Activities", :list, inda_hr.Model.Activity, options)
  end
end
