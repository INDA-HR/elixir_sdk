...
defmodule IndaHr.Api.ResumeToJobAds do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.MatchJobAdEvidenceResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_jobads_evidence_from_indexed_resume_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.BaseJobadMatchingEvidenceQuery.t, keyword()) :: {:ok, IndaHr.Model.MatchJobAdEvidenceResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def match_jobads_evidence_from_indexed_resume_post(connection, indexname, resume_id, base_jobad_matching_evidence_query, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.MatchJobAdEvidenceResponse{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_jobads_evidence_post(Tesla.Env.client, String.t, IndaHr.Model.JobadMatchingEvidenceQuery.t, keyword()) :: {:ok, IndaHr.Model.MatchJobAdEvidenceResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, IndaHr.Model.SearchJobAdMatchResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_jobads_from_indexed_resume_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.BaseJobadMatchingQuery.t, keyword()) :: {:ok, IndaHr.Model.SearchJobAdMatchResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def match_jobads_from_indexed_resume_post(connection, indexname, resume_id, base_jobad_matching_query, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.SearchJobAdMatchResponse{}},
      {400, %IndaHr.Model.ErrorModel{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_jobads_post(Tesla.Env.client, String.t, IndaHr.Model.JobadMatchingQuery.t, keyword()) :: {:ok, IndaHr.Model.SearchJobAdMatchResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
