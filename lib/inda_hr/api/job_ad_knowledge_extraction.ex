...
defmodule IndaHr.Api.JobAdKnowledgeExtraction do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.JobAdJobTitlesResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extract_jobtitles_from_jobad_post(Tesla.Env.client, IndaHr.Model.JobAdJobDescriptionRequest.t, keyword()) :: {:ok, IndaHr.Model.JobAdJobTitlesResponse.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def extract_jobtitles_from_jobad_post(connection, job_ad_job_description_request, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.JobAdJobTitlesResponse{}},
  ...
  - `{:ok, IndaHr.Model.JobAdLanguagesResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extract_languages_from_jobad_post(Tesla.Env.client, IndaHr.Model.JobAdJobDescriptionRequest.t, keyword()) :: {:ok, IndaHr.Model.HttpValidationError.t} | {:ok, IndaHr.Model.JobAdLanguagesResponse.t} | {:error, Tesla.Env.t}
  def extract_languages_from_jobad_post(connection, job_ad_job_description_request, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.JobAdLanguagesResponse{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
  ...
  - `{:ok, IndaHr.Model.JobAdSkillsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec extract_skills_from_jobad_post(Tesla.Env.client, IndaHr.Model.JobAdJobDescriptionRequest.t, keyword()) :: {:ok, IndaHr.Model.JobAdSkillsResponse.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def extract_skills_from_jobad_post(connection, job_ad_job_description_request, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.JobAdSkillsResponse{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
end
