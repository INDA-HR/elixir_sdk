...
defmodule IndaHr.Api.JobAdSearch do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.FoundJobAdsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec full_text_search_on_jobads_post(Tesla.Env.client, String.t, keyword()) :: {:ok, IndaHr.Model.FoundJobAdsResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def full_text_search_on_jobads_post(connection, indexname, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.FoundJobAdsResponse{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec search_applications_post(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.FoundJobAdsResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
