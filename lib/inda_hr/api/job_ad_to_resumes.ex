...
defmodule IndaHr.Api.JobAdToResumes do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.MatchResumeEvidenceResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_resumes_evidence_from_indexed_jobad_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.BaseResumeMatchingEvidenceQuery.t, keyword()) :: {:ok, IndaHr.Model.MatchResumeEvidenceResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def match_resumes_evidence_from_indexed_jobad_post(connection, indexname, jobad_id, base_resume_matching_evidence_query, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.MatchResumeEvidenceResponse{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_resumes_evidence_post(Tesla.Env.client, String.t, IndaHr.Model.ResumeMatchingEvidenceQuery.t, keyword()) :: {:ok, IndaHr.Model.MatchResumeEvidenceResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, IndaHr.Model.SearchResumeMatchResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_resumes_from_indexed_jobad_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.BaseResumeMatchingQuery.t, keyword()) :: {:ok, IndaHr.Model.SearchResumeMatchResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def match_resumes_from_indexed_jobad_post(connection, indexname, jobad_id, base_resume_matching_query, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.SearchResumeMatchResponse{}},
      {400, %IndaHr.Model.ErrorModel{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec match_resumes_post(Tesla.Env.client, String.t, IndaHr.Model.ResumeMatchingQuery.t, keyword()) :: {:ok, IndaHr.Model.SearchResumeMatchResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
