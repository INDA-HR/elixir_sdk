...
defmodule IndaHr.Api.ResumeParsing do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.DocumentAnonymizationResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec anonymize_cv_post(Tesla.Env.client, IndaHr.Model.BaseFileDoc.t, keyword()) :: {:ok, IndaHr.Model.DocumentAnonymizationResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def anonymize_cv_post(connection, base_file_doc, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.DocumentAnonymizationResponse{}},
  ...
  - `{:ok, IndaHr.Model.MultiEntityMapping.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec bulk_map_entity_post(Tesla.Env.client, IndaHr.Model.MultiEntityInput.t, keyword()) :: {:ok, IndaHr.Model.MultiEntityMapping.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def bulk_map_entity_post(connection, multi_entity_input, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.MultiEntityMapping{}},
  ...
  - `{:ok, IndaHr.Model.EntityMapping.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec map_entity_post(Tesla.Env.client, IndaHr.Model.EntityInput.t, keyword()) :: {:ok, IndaHr.Model.EntityMapping.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def map_entity_post(connection, entity_input, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.EntityMapping{}},
      {400, %IndaHr.Model.ErrorModel{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
  ...
  - `{:ok, IndaHr.Model.ExtractionItem.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec parse_resume_post(Tesla.Env.client, IndaHr.Model.BaseFile.t, keyword()) :: {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.ExtractionItem.t} | {:error, Tesla.Env.t}
  def parse_resume_post(connection, base_file, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.ExtractionItem{}},
      {422, %IndaHr.Model.ErrorModel{}},
      {415, %IndaHr.Model.ErrorModel{}},
      {500, %IndaHr.Model.ErrorModel{}},
      {503, %IndaHr.Model.ErrorModel{}},
  ...
  - `{:ok, IndaHr.Model.TextResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec text_extraction_post(Tesla.Env.client, IndaHr.Model.BaseFile.t, keyword()) :: {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.TextResponse.t} | {:error, Tesla.Env.t}
