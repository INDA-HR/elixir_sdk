...
defmodule IndaHr.Api.KeywordsSearch do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.AutocompleteResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec keywords_autocomplete_get(Tesla.Env.client, String.t, keyword()) :: {:ok, IndaHr.Model.AutocompleteResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def keywords_autocomplete_get(connection, term, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.AutocompleteResponse{}},
  ...
  - `{:ok, IndaHr.Model.KeywordsResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec similar_words_in_resume_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.SimilarWordsQuery.t, keyword()) :: {:ok, IndaHr.Model.KeywordsResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def similar_words_in_resume_post(connection, indexname, resume_id, similar_words_query, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.KeywordsResponse{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec similar_words_post(Tesla.Env.client, IndaHr.Model.SimilarWordsQuery.t, keyword()) :: {:ok, IndaHr.Model.KeywordsResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
