...
defmodule inda_hr.Api.ResumeSearch do
  ...
  {:error, Tesla.Env.t} on failure
  """
  @spec search_applicants_post(Tesla.Env.client, String.t, inda_hr.Model.AnyOfstringstring.t, keyword()) :: {:ok, inda_hr.Model.FoundCandidatesResponse.t} | {:ok, inda_hr.Model.ErrorModel.t} | {:ok, inda_hr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
