...
defmodule IndaHr.Api.ResumeManagement do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.ItemIdResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec add_resume_post(Tesla.Env.client, String.t, IndaHr.Model.FileItemRequest.t, keyword()) :: {:ok, IndaHr.Model.BaseItemIdResponse.t} | {:ok, IndaHr.Model.ItemIdResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def add_resume_post(connection, indexname, file_item_request, opts \\ []) do
    ...
    |> evaluate_response([
      {202, %IndaHr.Model.BaseItemIdResponse{}},
      {409, %IndaHr.Model.ErrorModel{}},
      {422, %IndaHr.Model.ErrorModel{}},
      {415, %IndaHr.Model.ErrorModel{}},
      {201, %IndaHr.Model.BaseItemIdResponse{}},
      {200, %IndaHr.Model.ItemIdResponse{}}
    ])
  end
  ...
  - `{:ok, IndaHr.Model.DeleteItemResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_pic_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.DeleteItemResponse.t} | {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def delete_pic_delete(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.DeleteItemResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  end
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec delete_resume_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.DeleteItemResponse.t} | {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, IndaHr.Model.BinaryItemResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_cv_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.BinaryItemResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def get_cv_get(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.BinaryItemResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  ...
  - `{:ok, IndaHr.Model.DocumentTextResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_cv_text_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.DocumentTextResponse.t} | {:error, Tesla.Env.t}
  def get_cv_text_get(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.DocumentTextResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  ...
  - `{:ok, IndaHr.Model.BinaryPicResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_pic_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.BinaryPicResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def get_pic_get(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.BinaryPicResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  ...
  - `{:ok, IndaHr.Model.GetItemResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_resume_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.GetItemResponse.t} | {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def get_resume_get(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.GetItemResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  ...
  - `{:ok, IndaHr.Model.PatchItemResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec patch_resume_patch(Tesla.Env.client, String.t, String.t, IndaHr.Model.PatchItemRequest.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.PatchItemResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  def patch_resume_patch(connection, indexname, resume_id, patch_item_request, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.PatchItemResponse{}},
      {404, %IndaHr.Model.ErrorModel{}},
      {409, %IndaHr.Model.BaseModelsErrorModel{}},
      {422, %IndaHr.Model.BaseModelsErrorModel{}}
    ])
  ...
  - `{:ok, IndaHr.Model.ResumeResponsesStatus.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec resume_status_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.ResumeResponsesStatus.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def resume_status_get(connection, indexname, resume_id, _opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.ResumeResponsesStatus{}},
      {404, %IndaHr.Model.ErrorModel{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_pic_put(Tesla.Env.client, String.t, String.t, IndaHr.Model.UpdatePicRequest.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.PatchItemResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
  ...
  - `{:ok, IndaHr.Model.BaseItemIdResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec update_resume_put(Tesla.Env.client, String.t, String.t, IndaHr.Model.UpdateItemRequest.t, keyword()) :: {:ok, IndaHr.Model.BaseModelsErrorModel.t} | {:ok, IndaHr.Model.BaseItemIdResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:error, Tesla.Env.t}
