...
defmodule IndaHr.Api.ResumeImport do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.ImportResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec aws_import_post(Tesla.Env.client, String.t, IndaHr.Model.DocsImportItemRequest.t, keyword()) :: {:ok, IndaHr.Model.ImportResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def aws_import_post(connection, indexname, docs_import_item_request, _opts \\ []) do
    ...
    |> evaluate_response([
      {202, %IndaHr.Model.ImportResponse{}},
  ...
  - `{:ok, IndaHr.Model.ImportStatus.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec import_status_get(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.ImportStatus.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
