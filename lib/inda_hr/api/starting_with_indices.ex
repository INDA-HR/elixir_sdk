...
defmodule inda_hr.Api.StartingWithIndices do
  @moduledoc """
  ...
  - `{:ok, inda_hr.Model.MostRecentResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec most_recent_resumes_get(Tesla.Env.client, String.t, keyword()) :: {:ok, inda_hr.Model.MostRecentResponse.t} | {:ok, inda_hr.Model.ErrorModel.t} | {:ok, inda_hr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def most_recent_resumes_get(connection, indexname, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %inda_hr.Model.MostRecentResponse{}},
  ...
  - `{:ok, inda_hr.Model.StatsIndex.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec stats_index_get(Tesla.Env.client, String.t, keyword()) :: {:ok, inda_hr.Model.StatsIndex.t} | {:ok, inda_hr.Model.ErrorModel.t} | {:ok, inda_hr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
