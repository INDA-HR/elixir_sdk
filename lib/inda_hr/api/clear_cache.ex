...
defmodule IndaHr.Api.ClearCache do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.CacheDeletion.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec clear_search_results_delete(Tesla.Env.client, String.t, String.t, keyword()) :: {:ok, IndaHr.Model.CacheDeletion.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def clear_search_results_delete(connection, indexname, search_id, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.CacheDeletion{}},
