...
defmodule inda_hr.Api.StandardizedData do
  @moduledoc """
  ...
  - `{:ok, inda_hr.Model.GetExtendedStandardDataResponse.t}` on success
  ...
  def get_company_size_get(connection, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %inda_hr.Model.GetExtendedStandardDataResponse{}},
  ...
  - `{:ok, inda_hr.Model.GetStandardDataResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  ...
  def get_company_type_get(connection, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %inda_hr.Model.GetStandardDataResponse{}},
      {404, %inda_hr.Model.ErrorModel{}},
      {503, %inda_hr.Model.ErrorModel{}},
      {422, %inda_hr.Model.HttpValidationError{}}
    ])
