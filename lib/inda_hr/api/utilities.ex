...
defmodule IndaHr.Api.Utilities do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.IndexCacheDeletionResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec clear_index_cache_delete(Tesla.Env.client, String.t, keyword()) :: {:ok, IndaHr.Model.IndexCacheDeletionResponse.t} | {:ok, IndaHr.Model.ErrorModel.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def clear_index_cache_delete(connection, indexname, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.IndexCacheDeletionResponse{}},
  ...
  - `{:ok, IndaHr.Model.Check.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec health_status_get(Tesla.Env.client, keyword()) :: {:ok, IndaHr.Model.Check.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
