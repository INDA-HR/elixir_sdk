...
defmodule IndaHr.Api.Universities do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.GetUniversityResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec get_university_get(Tesla.Env.client, String.t, keyword()) :: {:ok, IndaHr.Model.GetUniversityResponse.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def get_university_get(connection, university_id, opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.GetUniversityResponse{}},
  ...
  - `{:ok, IndaHr.Model.UniversityAutocompleteResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec university_autocomplete_get(Tesla.Env.client, String.t, keyword()) :: {:ok, IndaHr.Model.UniversityAutocompleteResponse.t} | {:ok, IndaHr.Model.HttpValidationError.t} | {:error, Tesla.Env.t}
  def university_autocomplete_get(connection, term, opts \\ []) do
    ...
    |> Connection.request(request)
    |> evaluate_response([
      {200, %IndaHr.Model.UniversityAutocompleteResponse{}},
      {422, %IndaHr.Model.HttpValidationError{}}
    ])
  end
end
