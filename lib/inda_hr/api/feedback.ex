...
defmodule IndaHr.Api.Feedback do
  @moduledoc """
  ...
  - `{:ok, IndaHr.Model.FeedbackResponse.t}` on success
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec info_extraction_feedback_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.FeedbackInfoItem.t, keyword()) :: {:ok, IndaHr.Model.HttpValidationError.t} | {:ok, IndaHr.Model.FeedbackResponse.t} | {:error, Tesla.Env.t}
  def info_extraction_feedback_post(connection, indexname, resume_id, feedback_info_item, _opts \\ []) do
    ...
    |> evaluate_response([
      {200, %IndaHr.Model.FeedbackResponse{}},
  ...
  - `{:error, Tesla.Env.t}` on failure
  """
  @spec semantic_search_feedback_post(Tesla.Env.client, String.t, String.t, IndaHr.Model.SemanticFeedbackRequest.t, keyword()) :: {:ok, IndaHr.Model.HttpValidationError.t} | {:ok, IndaHr.Model.FeedbackResponse.t} | {:error, Tesla.Env.t}
